...
# `r fontawesome::fa("fab fa-youtube", fill = "red")`  Instalación

Para instalar Anaconda, hay que seguir los siguientes pasos:
...
# `r fontawesome::fa("fab fa-youtube", fill = "red")` ¿Cómo usar Google Colab?
...
5. Para ver el uso de Google Colab, hacer clic en `r fontawesome::fa("fab fa-youtube", fill = "red")` al lado izquierdo de título de esta *slide*.
