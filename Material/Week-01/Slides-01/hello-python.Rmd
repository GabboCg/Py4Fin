...
date: 'Otoño 2021<br><br>`r icon::fa("link")` [bit.ly/jlt-rmed2018](https://bit.ly/jlt-rmed2018)<br>`r icon::fa("twitter")` [GabboCg](https://twitter.com/gabbocg)'
output:
...
* [<i class="fas fa-download"></i>](http://gcabrerag.rbind.io/blog/_site/teaching?panelset=syllabus) Calendario (Docencia Web).
...
* **Examen**: De caracter individual e Incluye todo lo visto en el curso.
...
* [<i class="fas fa-download"></i>](files/hw_policies.pdf) Política de entregas<sup>1</sup> (Docencia Web).

* Ver la normativa básica en el programa (Docencia Web).

.footnote[

[1] Valido para tareas y examen.
...
| Evaluación | Fecha                                                                              |
|------------|------------------------------------------------------------------------------------|
| Tarea 1    | Jueves 18 de Marzo (incluye hasta la clase 4)                                      |
| Tarea 2    | Jueves 25 de Marzo (incluye hasta la clase 6)                                      |
| Tarea 3    | Jueves 1 de Abril (incluye hasta la clase 8)                                       |
| Tarea 4    | Jueves 8 de Abril (incluye hasta la clase 10)                                      |
| Examen     | Se subirá el último día de clases y se entregará el Jueves 22 de Abril<sup>2</sup> |
