...
date: 'Otoño 2022<br><br>`r icons::icon_style(icons::fontawesome("link", style = "solid"), scale = 1, fill = "white")` [bit.ly/2ObxeQa](https://bit.ly/2ObxeQa)<br>`r icons::icon_style(icons::fontawesome("twitter", style = "brands"), scale = 1, fill = "white")` [GabboCg](https://twitter.com/gabbocg)'
output:
