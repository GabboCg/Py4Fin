...
\pretitle{%
  \begin{center}
  \LARGE
  \includegraphics[scale=0.10]{Latex/logo_uchile.png}\\[\bigskipamount]
}
...
Horario Oficina: $if(officehours)$$officehours$$else$TBD$endif$  &  Horario Clase: $if(classhours)$$classhours$$else$TBD$endif$\\
Oficina: $if(office)$$office$$else$TBD$endif$  & Sala: $if(classroom)$$classroom$$else$TBD$endif$\\
	&  \\
	\hline
	\end{tabular*}
